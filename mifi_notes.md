...
байт (bite) - 8 бит
диапазон: а один байт можно записать число от 00000000 до 11111111. В десятичной системе это от 0 до 255.(записать можно 256, потому что 0 тоже учитывается)
